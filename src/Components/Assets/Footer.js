      ...
      <div class="main-footer widgets-dark typo-light">
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget subscribe no-box">
                <h5 class="widget-title">
                  Triple top Pattern<span></span>
                </h5>
                <p>Data Platform</p>
                <p>Population Health Management</p>
                <p>Patient Engagement</p>
                <p>Tech-enabled Managed Services</p>
                <p>Cost Management</p>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="widget no-box">
                <h5 id="contact" class="widget-title">
                  Contact TTP HEALTH<span></span>
                </h5>
                <p>
                  Contact us today at:
                  <br />
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <p>Copyright Triple Top Pattern © 2023. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
